                ...
                <div className="col-lg-6">
                    <div className="why-choose-us-info-wrap">
                        <div className="section-title-area ltn__section-title-2">
                            <h6 className="section-subtitle ltn__secondary-color">// Why Choose Us</h6>
                        ...
                        <div className="row">
                            <div className="col-lg-12 col-md-6">
                                <div className="why-choose-us-feature-item">
                                    ...
                                    <div className="why-choose-us-feature-brief">
                                        <h3><Link  to="/service">Anytime Get Your Service</Link ></h3>
                            ...
                            <div className="col-lg-12 col-md-6">
                                <div className="why-choose-us-feature-item">
                                    ...
                                    <div className="why-choose-us-feature-brief">
                                        <h3><Link  to="/service">Hardcore Repair Service</Link ></h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor ut labore et dolore magna aliqua. Ut enim ad minim</p>
                                    </div>
                                </div>
                            </div>
