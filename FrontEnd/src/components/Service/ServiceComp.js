        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="section-title-area ltn__section-title-2 text-center">
              ...
              <h1 className="afex__section-title white-color">
        ...
        <div className="row justify-content-center">
          <div className="col-lg-4 col-sm-6">
            <div className="afex__service-item-1">
              ...
              <div className="service-item-brief">
                <h3>
                  <Link to="service-details.html">Performance Upgrades</Link>
                </h3>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="afex__service-item-1">
              ...
              <div className="service-item-brief">
                <h3>
                  <Link to="service-details.html">Anti Lock Break</Link>
                </h3>
                <p>Lorem ipsum dolor sit amet, consect</p>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="afex__service-item-1">
              ...
              <div className="service-item-brief">
                <h3>
                  <Link to="/service">Crash Car Repair</Link>
                </h3>
                <p>Lorem ipsum dolor sit amet, consect</p>
              </div>
            </div>
